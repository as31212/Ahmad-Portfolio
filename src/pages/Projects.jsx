    ...
    return(
        ...
        >
          Projects
            ...
            <SuperProject name="Tech-IT" img="Tech-it-homepage.png" github="https://github.com/as31212/Tech-it-Backend" description="Tech-IT is a mock e-commerce technology store designed to showcase full-stack development ability. The backend features login functionality, user authentication, session management, and advanced API endpoints, while the frontend delivers a seamless and intuitive user experience with dynamic interactions and responsive design." url="https://tech-its.netlify.app/" />
            </div>
        </section>
        </>
    );
